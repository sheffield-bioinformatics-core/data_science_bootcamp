...
But how many votes did the parties get? We can start by adding up the respective columns. The `summarize`/`summarise` collection of functions allow many ways to summarise our data. The general approach is to use specify what summary function you want to use on which columns, and say what you want the result to be called:-
